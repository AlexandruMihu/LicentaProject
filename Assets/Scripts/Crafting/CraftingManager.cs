...
public class CraftingManager : Singletone<CraftingManager>
{
    [Header("Config")]
    ...
    public void ShowRecipe(Recipe recipe)
    {
        ...
        item1Amount.text = $"{Inventory.Instance.GetItemCurrentStock(recipe.Item1.ID)}/"+
            $"{recipe.Item1Amount}";
        item2Amount.text = $"{Inventory.Instance.GetItemCurrentStock(recipe.Item2.ID)}/" +
           $"{recipe.Item2Amount}";
